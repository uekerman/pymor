...
class Sum(BinaryOp):  numpy_symbol = '+'; fenics_symbol = operator.add;     fenics_conditional = False
class Diff(BinaryOp): numpy_symbol = '-'; fenics_symbol = operator.sub;     fenics_conditional = False
class Prod(BinaryOp): numpy_symbol = '*'; fenics_symbol = operator.mul;     fenics_conditional = False
class Div(BinaryOp):  numpy_symbol = '/'; fenics_symbol = operator.truediv; fenics_conditional = False


class Pow(BinaryOp):  numpy_symbol = '**'; fenics_symbol = 'elem_pow'; fenics_conditional = False
class LE(BinaryOp):   numpy_symbol = '<='; fenics_symbol = 'le';       fenics_conditional = True
class GE(BinaryOp):   numpy_symbol = '>='; fenics_symbol = 'ge';       fenics_conditional = True
class LT(BinaryOp):   numpy_symbol = '<';  fenics_symbol = 'lt';       fenics_conditional = True
class GT(BinaryOp):   numpy_symbol = '>';  fenics_symbol = 'gt';       fenics_conditional = True
class Mod(BinaryOp):  numpy_symbol = '%';  fenics_symbol = None;       fenics_conditional = None


class sin(UnaryFunctionCall):      numpy_symbol = 'sin';     fenics_symbol = 'sin'
class cos(UnaryFunctionCall):      numpy_symbol = 'cos';     fenics_symbol = 'cos'
class tan(UnaryFunctionCall):      numpy_symbol = 'tan';     fenics_symbol = 'tan'
class arcsin(UnaryFunctionCall):   numpy_symbol = 'arcsin';  fenics_symbol = 'asin'
class arccos(UnaryFunctionCall):   numpy_symbol = 'arccos';  fenics_symbol = 'acos'
class arctan(UnaryFunctionCall):   numpy_symbol = 'arctan';  fenics_symbol = 'atan'
class sinh(UnaryFunctionCall):     numpy_symbol = 'sinh';    fenics_symbol = 'sinh'
class cosh(UnaryFunctionCall):     numpy_symbol = 'cosh';    fenics_symbol = 'cosh'
class tanh(UnaryFunctionCall):     numpy_symbol = 'tanh';    fenics_symbol = 'tanh'
class exp(UnaryFunctionCall):      numpy_symbol = 'exp';     fenics_symbol = 'exp'
class log(UnaryFunctionCall):      numpy_symbol = 'log';     fenics_symbol = 'ln'
class sqrt(UnaryFunctionCall):     numpy_symbol = 'sqrt';    fenics_symbol = 'sqrt'
class sign(UnaryFunctionCall):     numpy_symbol = 'sign';    fenics_symbol = 'sign'
...
class min(UnaryReductionCall):  numpy_symbol = 'min';  fenics_op = 'min_value'
class max(UnaryReductionCall):  numpy_symbol = 'max';  fenics_op = 'max_value'
class sum(UnaryReductionCall):  numpy_symbol = 'sum';  fenics_op = operator.add
class prod(UnaryReductionCall): numpy_symbol = 'prod'; fenics_op = operator.mul
...
class Pi(BaseConstant): numpy_symbol = 'pi'; fenics_symbol = 'pi'
class E(BaseConstant):  numpy_symbol = 'e';  fenics_symbol = 'e'
